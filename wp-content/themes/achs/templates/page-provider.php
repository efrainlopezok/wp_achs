...
function child_do_custom_loop() {
    $args = array('post_type' => 'provider','posts_per_page'=>-1);
    $loop = new WP_Query($args);
    if ( $loop->have_posts() ) : 
        echo '<div class="slick-provider">';
                ...
                <div class="row">
                    ...
                    <div class="col s12">
                        <ul class="tabs tabs-fixed-width">
                            ...
                            <li class="tab col s3"><a href="#tab2"><?php echo $franconia_content_tab_title;?></a></li>
                            <li class="tab col s3"><a href="#tab3"><?php echo $warren_content_tab_title;?></a></li>
                            <li class="tab col s3"><a href="#tab4"><?php echo $whitefield_content_tab_title;?></a></li>
                            <li class="tab col s3"><a href="#tab5"><?php echo $woodsville_content_tab_title;?></a></li>
                        </ul>
                    </div>
